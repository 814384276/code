$(function () {
    ...
    $(".nav_list>li:nth-of-type(4)").hover(function () {
        $("#nav_content").delay(400).slideDown();
    }, function () {
        $("#nav_content").slideUp("fast");
    });
    ...
    var timer = setInterval(function () {
        var date = new Date();
        var dis = parseInt((new Date("2019/2/15 00:00:00") - date) / 1000);  //过去某一时间
        var sec = toDb(dis % 60);
    ...
    //加入购物车
    $("#today_new_ul").on("click", ".add_cart", function () {
        //console.log($(this));
